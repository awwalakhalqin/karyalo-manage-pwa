            ...
            >
              ...
              <div className="flex items-center justify-between border-t border-border/60 pt-3">
                <div className="flex items-center gap-2">
                  ...
                  {isOutOfStock ? (
                    <span className="inline-flex items-center gap-1 rounded-full bg-status-critical/10 px-2.5 py-0.5 text-[10px] font-semibold text-status-critical">
                      <AlertTriangle size={11} aria-hidden="true" />
                      Stok Habis
                    </span>
                  ) : isLowStock ? (
                    <span className="inline-flex items-center gap-1 rounded-full bg-status-warning/10 px-2.5 py-0.5 text-[10px] font-semibold text-status-warning">
                      <AlertTriangle size={11} aria-hidden="true" />
                      Sisa {p.stock}
                    </span>
                  ) : (
                    <span className="inline-flex items-center gap-1 rounded-full bg-soft-sand px-2.5 py-0.5 text-[10px] font-medium text-ink">
