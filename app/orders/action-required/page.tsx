...
export default async function ActionRequiredOrdersPage() {
  ...
  return (
    <div className="mx-auto w-full max-w-(--container-wide) min-w-0 px-3.5 py-5 sm:px-6 sm:py-8 box-border">
      <div className="mb-4">
        <h1 className="text-xl font-bold tracking-tight text-ink sm:text-2xl">Perlu Tindakan</h1>
        <p className="mt-0.5 text-xs text-muted sm:text-sm">{orders.length} pesanan memerlukan respon segera</p>
      </div>
      <SampleDataBanner />
      <OrderFilterTabs />
