    ...
    <div className="mx-auto max-w-(--container-wide) px-4 py-6 md:px-6 md:py-8">
      ...
      <div className="mb-6 flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
        <div className="flex items-center gap-3.5">
          <div className="flex size-12 items-center justify-center rounded-2xl bg-[#ee4d2d]/10 text-[#ee4d2d] shadow-xs">
            <ShoppingBag size={26} aria-hidden="true" />
          </div>
          <div>
            <div className="flex flex-wrap items-center gap-2">
              <h1 className="text-xl font-bold text-ink md:text-2xl">Shopee Open Platform API</h1>
            ...
            <p className="mt-0.5 text-xs text-muted">
              Manajemen koneksi toko, sinkronisasi stok multi-gudang, dan otomasi pesanan Shopee.
            </p>
          </div>
        </div>
        ...
        <div className="flex items-center gap-2">
          <button
            ...
            disabled={isSyncing}
            className="tap-target inline-flex items-center gap-1.5 rounded-lg border border-border bg-warm-white px-3.5 py-2 text-xs font-semibold text-ink shadow-xs hover:border-karyalo-green disabled:opacity-50"
          >
          ...
          <Link
            href="/orders/shopee"
            className="tap-target inline-flex items-center gap-1.5 rounded-lg bg-deep-pine px-4 py-2 text-xs font-semibold text-warm-white shadow-xs hover:bg-deep-pine/90"
          >
      ...
      <div className="grid grid-cols-1 gap-6 lg:grid-cols-3">
        ...
        <div className="flex flex-col gap-6 lg:col-span-1">
          {/* Card Toko Terhubung */}
          <div className="rounded-(--radius-card) border border-border bg-warm-white p-5 shadow-xs">
        ...
        <div className="flex flex-col gap-6 lg:col-span-2">
          ...
          <div className="rounded-(--radius-card) border border-border bg-warm-white p-5 shadow-xs">
            ...
            <div className="mt-5 flex flex-col gap-4">
              ...
              <div className="flex items-start justify-between gap-4 rounded-xl border border-border/80 bg-soft-sand/40 p-4">
          ...
          <div className="rounded-(--radius-card) border border-border bg-warm-white p-5 shadow-xs">
            ...
            <div className="mt-4 flex flex-col gap-3 text-xs">
              <div className="flex flex-col gap-1 rounded-lg border border-border bg-soft-sand p-3">
                ...
                <code className="font-mono text-xs text-karyalo-green select-all">
